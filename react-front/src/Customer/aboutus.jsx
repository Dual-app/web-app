    ...
    <div>
      ...
      <div className="min-h-screen bg-white text-gray-800">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url('https://images.ft.com/v3/image/raw/https%3A%2F%2Fd1e00ek4ebabms.cloudfront.net%2Fproduction%2F3f8d8a91-00df-4745-980c-9d776e8972e7.jpg?source=next-article&fit=scale-down&quality=highest&width=700&dpr=1')",
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl px-4">
            ...
            <p className="text-white text-sm md:text-base">
              Trusted Myanmar Legal Experts — Dedicated to Integrity, Justice,
              and Client Success.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10">
            At LegalEase, we are committed to providing clear, honest, and
            professional legal guidance for individuals and businesses across
            Myanmar. We combine traditional legal expertise with modern
            solutions to ensure justice is accessible for everyone.
          </p>

          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl font-semibold mb-3 text-[#1A3636]">
                Our Commitment
              </h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Since our establishment in 2020, LegalEase Law Firm has handled
                hundreds of civil, corporate, and criminal cases successfully.
                We take pride in our ethical standards, transparency, and
              ...
              <p className="text-gray-600 leading-relaxed">
                We understand the sensitivity of legal matters. All client
                details, consultations, and documents are treated with the
                highest level of confidentiality. Your information will never be
                shared or disclosed — your trust is our foundation.
              </p>
            </div>
        ...
        <section className="bg-[#f8f9f8] py-16">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-10">
              At LegalEase Law Firm, we make the legal consultation process
              simple, transparent, and efficient — ensuring every client
              receives the best possible guidance and representation from start
              to finish.
            </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Clients can easily book an appointment online through our
                  platform. Our admin team reviews each booking and confirms the
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm">
                  A suitable lawyer is carefully assigned based on the client’s
                  case type — whether corporate, civil, family, or criminal —
                  ensuring expert representation.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Once the appointment is confirmed, the discussion with your
                  assigned lawyer will take place at the LegalEase Office in a
            ...
            <div className="mt-12 bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 text-sm">
                After the initial consultation, clients can follow up through
                our platform for updates, document sharing, and ongoing support
              ...
              {[
                {
                  ...
                  success:
                    "Led a $10M cross-border corporate merger with zero legal conflict post-integration.",
                },

                {
                  ...
                  success:
                    "Secured acquittal in one of Myanmar’s most complex criminal defense cases in 2023.",
                },
                {
                  name: "David Smith",
                  ...
                  success:
                    "Resolved over 200 civil and family cases with amicable and fair outcomes for all parties.",
                },
              ].map((lawyer) => (
                <div
                  key={lawyer.name}
        ...
        <section className="bg-white py-16">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-12">
              ...
              dedication, professionalism, and consistent success in protecting
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="bg-[#f8f9f8] rounded-lg shadow-md p-6 hover:shadow-lg transition">
                ...
                <p className="text-gray-600 text-sm">
                  Honored by the Yangon Legal Association for outstanding
                  service and client satisfaction in corporate and civil law.
                </p>
              </div>
              ...
              <div className="bg-[#f8f9f8] rounded-lg shadow-md p-6 hover:shadow-lg transition">
                ...
                <p className="text-gray-600 text-sm">
                  Our experienced legal team has successfully managed complex
                  cases with dedication, fairness, and transparency.
                </p>
              </div>
              ...
              <div className="bg-[#f8f9f8] rounded-lg shadow-md p-6 hover:shadow-lg transition">
                ...
                <p className="text-gray-600 text-sm">
                  Recognized for exceptional legal support and ethical standards
                  by national and international business clients.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-4xl mx-auto px-6 py-16 text-center">
          <h2 className="text-2xl font-semibold text-[#1A3636] mb-4">
            Our Promise
          </h2>
          <p className="text-gray-600 leading-relaxed">
            Whether you’re seeking legal advice, defense, or consultation —
            LegalEase stands as your trusted partner. We combine experience,
            confidentiality, and compassion to ensure that every client feels
            heard, respected, and legally protected.
          </p>
        </section>
